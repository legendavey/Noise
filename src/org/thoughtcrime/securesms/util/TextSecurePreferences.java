...
public class TextSecurePreferences {
  ...
  public  static final String LEGACY_REGISTERED_PREF           = "pref_registered";
  ...
  public static boolean isPushRegistered(Context context) {
    boolean legacyRegistered = getBooleanPreference(context, LEGACY_REGISTERED_PREF, false);
    if (legacyRegistered) {
      setBooleanPreference(context, REGISTERED_GCM_PREF, legacyRegistered);
    }
